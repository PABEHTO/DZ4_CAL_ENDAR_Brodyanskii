...
//СТАБИЛЬНОННООНООСТЬсу
    ...
    Date add(int sec, int minu, int hou, int da, int mon,int ye){
        Date other; other.second=sec; other.minute=minu; other.hour=hou; other.day=da; other.month=mon; other.year=ye;
    ...
    Date sub(int sec, int minu, int hou, int da, int mon,int ye){
        Date other; other.second=sec; other.minute=minu; other.hour=hou; other.day=da; other.month=mon; other.year=ye;
